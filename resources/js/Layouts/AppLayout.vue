    ...
    <div>
        ...
        <div class="flex h-screen overflow-hidden bg-gray-100">
            ...
            >
                ...
                <div class="h-20 flex items-center justify-between px-4 border-b border-ugel-azul/10 shrink-0">
                    <Link :href="route('dashboard')" class="flex items-center gap-3 overflow-hidden">
                        <ApplicationMark class="block h-9 w-auto shrink-0" />
                        <span 
                            class="font-bold text-ugel-guinda tracking-wide whitespace-nowrap transition-all duration-300"
                ...
                <div class="flex-1 overflow-y-auto overflow-x-hidden flex flex-col py-4 custom-scrollbar">
                    <nav class="px-3 space-y-1.5">
                        <Link
                            ...
                            :key="item.name"
                            :href="item.href"
                            class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold transition relative"
                            :class="[
                ...
                <div class="mt-auto p-4 border-t border-ugel-azul/10">
                    <Dropdown align="top" :width="isSidebarCollapsed ? '48' : 'w-full'" contentClasses="mb-2 bg-white">
                        <template #trigger>
                            <button
                                class="w-full flex items-center gap-3 rounded-xl border border-transparent hover:bg-gray-50 px-2 py-2 text-left transition duration-200"
                        ...
                        <template #content>
                            <div class="px-4 py-2 text-xs text-gray-400 font-semibold tracking-wider">
                                Cuenta
                            </div>
