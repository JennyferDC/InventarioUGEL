...
<template>
    <div class="min-h-screen bg-gray-50 pb-12">
        <Head :title="`Plan anual de mantenimiento informático - ${plan.titulo}`" />

        <header class="bg-white shadow-sm border-b border-gray-200 py-6 mb-8">
            <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                <h1 class="font-bold text-3xl md:text-4xl text-ugel-guinda leading-tight">
                    Plan anual de mantenimiento informático - {{ plan.titulo }}
                </h1>
                <h2 class="text-xl font-semibold text-gray-500 mt-2 tracking-wide">
                    OFICINA DE INFORMÁTICA
                </h2>
            </div>
        </header>

        <main class="max-w-7xl mx-auto px-6 lg:px-8 space-y-6">
            <!-- Info Plan -->
                                        ...
                                        <td class="px-6 py-4 text-center align-middle">
                                            <div class="flex justify-center">
                                                <div 
                                                    ...
                                                    :title="getStatusColor(item) === 'bg-red-400 animate-pulse' ? 'En curso' : (getStatusColor(item) === 'bg-orange-400' ? 'Próximo' : (getStatusColor(item) === 'bg-green-600' ? 'Finalizado' : 'A tiempo'))"
                                                ></div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
