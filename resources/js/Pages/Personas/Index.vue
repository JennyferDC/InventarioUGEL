...
const filteredPersonas = computed(() => {
    ...
    return personas.value.filter((persona) => {
        const coincideBusqueda =
            ...
            persona.area?.nombre?.toLowerCase().includes(term);

        const coincideArea =
            areaId === "todos" || Number(areaId) === Number(persona.id_area);
...
const crearPersona = async (payload) => {
    if (!payload?.nombre_completo || !payload.id_area) return;
                ...
                >
                    ...
                    >
                        ...
                        <div class="w-full sm:w-60">
                            <label class="sr-only" for="filtro-area"
                        ...
                        <table class="min-w-full divide-y divide-ugel-azul/20">
                            ...
                            <tbody v-else>
                                <tr>
                                    ...
                                    >
                                        No hay personas registradas o que
